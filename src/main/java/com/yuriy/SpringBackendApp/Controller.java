...
public class Controller {
    ...
    public List<User> getUsersWithFirstNameContaining(@RequestParam String firstName) {
        logger.info("GET request to /users path to get list of users with specific first name");
